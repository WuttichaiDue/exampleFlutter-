...
String selectedUrl = 'https://www.google.com/search?q=';
      ...
      routes: {
        ...
        '/widget': (_) {
          return WebviewScaffold(
            url: '$selectedUrl${Global.textString}',
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final _urlCtrl = TextEditingController(text: selectedUrl + Global.textString);
  ...
  void initState() {
    ...
    _urlCtrl.addListener(() {
      selectedUrl = _urlCtrl.text + Global.textString;
    });
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                flutterWebViewPlugin.launch(selectedUrl + Global.textString,
                    hidden: true);
              },
